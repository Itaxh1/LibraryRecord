...
(done)  * 20 points: API has a `POST /photos` endpoint that supports image uploads through multipart formdata request bodies
   (donw) * 5 points: `POST /photos` endpoint correctly accepts multipart formdata bodies
